<?php
 include("../include/db.php");
     if (isset($_GET['bloodkey'])) {
         $bloodkey = $_GET['bloodkey'];
         ...
         if($_SERVER['REQUEST_METHOD'] == 'POST')
    {
        ...
        $bloodkey = $_POST['bloodkey'];
        $cdate = $_POST['cdate'];
        $Msg = 'Update Succesfull';
         $sql = " update donatedbloodtbl set fullName = '".$fullname."', mobileNumber = '".$mobileno."', emailAddress = '".$emailid."', age = '".$age."', gender = '".$gender."', bloodGroup = '".$bloodgroup."', address = '".$address."', cdate = '".$cdate."' where bloodkey=" .$bloodkey;

                if ($conn->query($sql) === TRUE) {
                    echo "<script type='text/javascript'>alert('$Msg');window.location.href = '../page/donorView.php'</script>";
                }
                else {
    ...
    <br>
	   ...
	   <div class="container">
         <div class="row">
             <div class="col-lg-12">
                 <div class="card">
                     <div class="card-header">Edit Donor Blood</div>
                     <div class="card-body">
                         <form class="" action="" method="post">
                            ...
                            <div class="row">
                                 ...
                                 <input type="hidden" class="form-control" name="bloodkey" placeholder="Enter Address" value="<?php echo $row['bloodkey']; ?>" >
                                 </div>
